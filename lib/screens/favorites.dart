...
class Favorites extends StatelessWidget {
  final List<Place> _places = [
    Place(
        ...
        address: "TSC, Shahabag, Dhaka, Bangladesh"),
    Place(name: "Pizza Hut", address: "TSC, Shahabag, Dhaka, Bangladesh"),
    Place(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(
              "My favorites",
              style: _theme.textTheme.subtitle1?.merge(TextStyle(fontSize: 26.0)),
            ),
            SizedBox(
              height: 20.0,
            ),
